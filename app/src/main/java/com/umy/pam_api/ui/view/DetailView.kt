...
import com.umy.pam_api.ui.viewmodel.DetailUiState
import com.umy.pam_api.ui.viewmodel.DetailViewModel
import com.umy.pam_api.ui.viewmodel.toKgr
    ...
    when {
        ...
        detailUiState.isUiEventNotEmpty -> {
            Column(
                ...
                ItemDetailMhs(
                    kategori = detailUiState.detailUiEvent.toKgr(),
                    modifier = modifier
                )
            }
        }
...
fun ItemDetailMhs(
    ...
    Card(
        ...
        Column(
            ...
            ComponentDetailMhs(judul = "ID KATEGORI", isinya = kategori.id_kategori)
            Spacer(modifier = Modifier.padding(4.dp))
            ComponentDetailMhs(judul = "Nama KATEGORI", isinya = kategori.nama_kategori)
        }
    }
}
